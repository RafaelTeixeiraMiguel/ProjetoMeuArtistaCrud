                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <body>                   
                                        ...
                                        <div> É preciso informar o índice do usuário</div>
                                        <%}else{%>
                                        <%try{%>
                                        <%int i = Integer.parseInt(request.getParameter("i"));%>
                                        <%Usuario user= Db.getUsuarios().get(i);%>
                                        <h4>Nome</h4><div><%= user.getNome()%></div><br>
                                        <h4>Usuário</h4><div><%= user.getUsuario()%></div><br>
                                        <h4>Tipo de usuário</h4><div><%= user.getTipoUsuario()%></div><br>
                                        <%}catch(Exception e){%>
